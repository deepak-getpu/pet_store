...
public class PetStoreController {
	...
	@ResponseStatus(code = HttpStatus.CREATED)
	public PetStoreCustomer addCustomeroPetStore(@PathVariable Long petStoreId, @RequestBody PetStoreCustomer petStoreCustomer) {
	...
	public PetStoreData retrivePetStoresById (@PathVariable Long petStoreId) {
